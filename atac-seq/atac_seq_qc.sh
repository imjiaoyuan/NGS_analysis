...
FASTQ_FILES=($(ls ${RAW_DIR}/*.fastq.gz 2>> ${LOG_DIR}/job_${SLURM_JOB_ID}.log))
...
multiqc ${TMP_DIR} -o ${REPORT_DIR} -n "ATACseq_QC_report" >> ${LOG_DIR}/job_${SLURM_JOB_ID}.log 2>&1
